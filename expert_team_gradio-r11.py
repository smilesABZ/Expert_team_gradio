...
# Function to evaluate responses (Improved Extraction with Regular Expressions)
async def evaluate_responses(responses, model='gemma2:2b', temperature=0.7):
    ...
    try:
        ...
        perfect_answer = perfect_answer_match.group(1).strip() if perfect_answer_match else "Perfect answer not found."
        illustration_prompt = illustration_prompt_match.group(1).strip() if illustration_prompt_match else "Illustration prompt not found."
