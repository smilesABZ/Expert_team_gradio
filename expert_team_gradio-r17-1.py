...
iface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(possible_roles, label="Expert Role 1", info="Choose the first expert role to consult."), gr.Dropdown(model_options, label="Model for Role 1", info="Select the language model for Expert 1."), # Added info
        ...
        gr.Dropdown(list(temperature_presets.keys()), label="Temperature for Role 1", info="Set creativity level for Expert 1 (Cautious, Balanced, Creative)."), # More descriptive temperature labels
        gr.Dropdown(list(temperature_presets.keys()), label="Temperature for Role 2", info="Set temperature for Expert 2."),
        gr.Dropdown(list(temperature_presets.keys()), label="Temperature for Role 3", info="Temperature for Expert 3."),
        gr.Dropdown(list(temperature_presets.keys()), label="Temperature for Role 4", info="Temperature for Expert 4."),
        gr.Dropdown(list(temperature_presets.keys()), label="Evaluation Temperature", info="Temperature for Senior Manager evaluation."),
