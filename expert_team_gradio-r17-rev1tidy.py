...
iface = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(list(temperature_presets.keys()), label="Approach style Expert 1", info="Set approach for Expert 1 (Cautious, Balanced, Creative)."), # More descriptive temperature labels
