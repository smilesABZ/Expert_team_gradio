...
def gradio_interface():
    ...
    eval_models_list = ["gemma2:2b","gemma3:4b", "dolphin-llama3:latest", "llama2:13b"] # Evaluation models list
...
async def process_prompt(prompt_text, role1, role2, role3, role4, model1, model2, model3, model4, temp_role1, temp_role2, temp_role3, temp_role4, eval_model_name, eval_temperature_setting):
    ...
    evaluation_content, perfect_answer_text, illustration_prompt_text = evaluation_results[4:7] # Extract evaluation text and prompts
