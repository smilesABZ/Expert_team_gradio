...
def gradio_interface(question, role1, role2, role3, role4): # MODIFIED to accept 5 arguments
    return "Response 1 from " + role1, \
           "Response 2 from " + role2, \
           "Response 3 from " + role3, \
           "Response 4 from " + role4, \
           "Evaluation Output", \
