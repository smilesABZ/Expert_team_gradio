...
iface = gr.Interface(
    ...
    inputs=[
        "text",
        gr.CheckboxGroup([role['name'] for role in possible_roles], label="Select Team Roles") # CheckboxGroup for role selection
    ],
    outputs=[
        gr.Textbox(label="Strategic Business Advisor Response"), # Labels updated to match dynamic roles
        ...
        gr.Textbox(label="Perfect Answer"),  # Added output for perfect answer
        gr.Textbox(label="Illustration Prompt")  # Added output for illustration prompt
    ],
